...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		propertyName: 'titulo',			//property in marker.options(or feature.properties for vector layer) trough filter elements in layer,
		...
		delayType: 400,					//400 delay while typing for show tooltip
		...
		autoCollapseTime: 1200,			//1200 delay for autoclosing alert and collapse after blur
		textErr: 'Location not found',	//error message
		textCancel: 'Cancel',		    //title in cancel button		
		textPlaceholder: 'Digite seu bairro ou delegacia',   //placeholder value
	...
	_createInput: function (text, className) {
		...
		label.textContent = "Digite seu bairro";
