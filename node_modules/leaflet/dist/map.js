	...
	for(i in dpBairros) {
		let title = dpBairros[i].title,
			...
			marker.bindPopup('<p><b><center>1ª DP</center></b>Delegado Titular: <b>George Wandré Assunção</b><br><a href=#>E-mail: primeiradp@policiacivil.ap.gov.br</a><br>Endereço: Rua Mateus Valente do Couto, nº 806, Nova Esperança</p>');
	...
	"Bairros": bairros,
	"Delegacias de bairro": markersLayer
	};
	...
	map.addControl( new L.Control.Search({layer:markersLayer,buildTip:c}));
